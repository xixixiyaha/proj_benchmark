...
public class CartInfoStorage {
    ...
    static final String GET_CART_BY_ACCOUNT ="SELECT cart_id, account_id,obj_id,merchant_id,incart_quantity,incart_select FROM CART_INFOS WHERE account_id = ?";
    static final String GET_LIMIT_CART_BY_ACCOUNT ="SELECT cart_id, account_id,obj_id,merchant_id,incart_quantity,incart_select FROM CART_INFOS WHERE account_id = ? ORDER BY update_time DESC LIMIT ?";

    static final String GET_OBJ_QUANTITY_BY_ACCOUNT_OBJ ="SELECT cart_id,incart_quantity FROM CART_INFOS WHERE account_id = ? AND obj_id = ?";
    ...
    static final String UPDATE_OBJ_SELECT_BY_ACCOUNT_OBJ ="UPDATE CART_INFOS SET incart_select = ? WHERE  account_id = ? AND obj_id = ?";

    static final String DELETE_CART_OBJ_BY_ID ="DELETE FROM CART_INFOS WHERE cart_id = ?";
    static final String DELETE_CART_BY_ACCOUNT ="DELETE FROM CART_INFOS WHERE account_id = ?";
    static final String ADD_CART_OBJ="INSERT INTO CART_INFOS (account_id,obj_id,merchant_id,incart_quantity,incart_select) VALUES(?,?,?,?,?)";
