package com.freeb.DaRPC.RawVersion.Server;
...
public class TRdmaServerRaw {
    ...
    public void run() throws Exception{
        ...
        TRdmaService rpcService = new TRdmaService(new SearchService.Processor<SearchService.Iface>(null));//TODO@Notice in prectice should not be null
