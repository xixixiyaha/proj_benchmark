...
import com.freeb.thrift.ProductService;
...
public class ThriftProdClientImpl implements Closeable {
    public final TTransport transport;
    public final TProtocol protocol;
    public final ProductService.Client client;
    private static int clientNum = 0;
    public ThriftProdClientImpl(String host, int port) {
