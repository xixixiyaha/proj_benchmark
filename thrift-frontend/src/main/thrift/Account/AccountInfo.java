...
public class AccountInfo implements org.apache.thrift.TBase<com.freeb.Accounts.AccountInfo, com.freeb.Accounts.AccountInfo._Fields>, java.io.Serializable, Cloneable, Comparable<com.freeb.Accounts.AccountInfo> {
  ...
  private static final org.apache.thrift.protocol.TField USER_TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("userTag", org.apache.thrift.protocol.TType.LIST, (short)5);
  private static final org.apache.thrift.protocol.TField USER_CARD_FIELD_DESC = new org.apache.thrift.protocol.TField("userCard", org.apache.thrift.protocol.TType.STRING, (short)6);
  ...
  public List<Integer> userTag; // optional
  public String userCard; // optional
  ...
  private static final _Fields optionals[] = {_Fields.USER_DESCRIPTION, _Fields.USER_TAG, _Fields.USER_CARD};
  ...
  static {
    ...
    tmpMap.put(_Fields.USER_CARD, new org.apache.thrift.meta_data.FieldMetaData("userCard", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(com.freeb.Accounts.AccountInfo.class, metaDataMap);
  }
   ...
   */
  public AccountInfo(com.freeb.Accounts.AccountInfo other) {
    ...
    if (other.isSetUserTag()) {
      List<Integer> __this__userTag = new ArrayList<Integer>(other.userTag);
      this.userTag = __this__userTag;
    }
    if (other.isSetUserCard()) {
      this.userCard = other.userCard;
    }
  }

  public com.freeb.Accounts.AccountInfo deepCopy() {
    return new com.freeb.Accounts.AccountInfo(this);
  }
  ...
  public com.freeb.Accounts.AccountInfo setUserId(long userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public com.freeb.Accounts.AccountInfo setUserName(String userName) {
    this.userName = userName;
    return this;
  }
  ...
  public com.freeb.Accounts.AccountInfo setUserPasswd(String userPasswd) {
    this.userPasswd = userPasswd;
    return this;
  }
  ...
  public com.freeb.Accounts.AccountInfo setUserDescription(String userDescription) {
  ...
  public java.util.Iterator<Integer> getUserTagIterator() {
    return (this.userTag == null) ? null : this.userTag.iterator();
  }

  public void addToUserTag(int elem) {
    if (this.userTag == null) {
      this.userTag = new ArrayList<Integer>();
    }
    this.userTag.add(elem);
  }
  ...
  public com.freeb.Accounts.AccountInfo setUserTag(List<Integer> userTag) {
  ...
  public com.freeb.Accounts.AccountInfo setUserCard(String userCard) {
    this.userCard = userCard;
    return this;
  }

  public void unsetUserCard() {
    this.userCard = null;
  }

  /** Returns true if field userCard is set (has been assigned a value) and false otherwise */
  public boolean isSetUserCard() {
    return this.userCard != null;
  }

  public void setUserCardIsSet(boolean value) {
    if (!value) {
      this.userCard = null;
    }
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof com.freeb.Accounts.AccountInfo)
      return this.equals((com.freeb.Accounts.AccountInfo)that);
    return false;
  }

  public boolean equals(com.freeb.Accounts.AccountInfo that) {
    if (that == null)
      return false;
    ...
    boolean this_present_userCard = true && this.isSetUserCard();
    boolean that_present_userCard = true && that.isSetUserCard();
    if (this_present_userCard || that_present_userCard) {
      if (!(this_present_userCard && that_present_userCard))
        return false;
      if (!this.userCard.equals(that.userCard))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_userCard = true && (isSetUserCard());
    list.add(present_userCard);
    if (present_userCard)
      list.add(userCard);
  ...
  @Override
  public int compareTo(com.freeb.Accounts.AccountInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetUserCard()).compareTo(other.isSetUserCard());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUserCard()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.userCard, other.userCard);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class AccountInfoStandardScheme extends StandardScheme<com.freeb.Accounts.AccountInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, com.freeb.Accounts.AccountInfo struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.userTag = new ArrayList<Integer>(_list0.size);
                int _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readI32();
                  struct.userTag.add(_elem1);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // USER_CARD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.userCard = iprot.readString();
              struct.setUserCardIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, com.freeb.Accounts.AccountInfo struct) throws TException {
      struct.validate();
      ...
      if (struct.userTag != null) {
        if (struct.isSetUserTag()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.userTag.size()));
            for (int _iter3 : struct.userTag)
            {
      ...
      if (struct.userCard != null) {
        if (struct.isSetUserCard()) {
          oprot.writeFieldBegin(USER_CARD_FIELD_DESC);
          oprot.writeString(struct.userCard);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class AccountInfoTupleScheme extends TupleScheme<com.freeb.Accounts.AccountInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, com.freeb.Accounts.AccountInfo struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, com.freeb.Accounts.AccountInfo struct) throws TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.userTag = new ArrayList<Integer>(_list5.size);
          int _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readI32();
            struct.userTag.add(_elem6);
          }
        }
        struct.setUserTagIsSet(true);
      }
