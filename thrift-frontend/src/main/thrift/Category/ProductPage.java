...
public class ProductPage implements org.apache.thrift.TBase<ProductPage, ProductPage._Fields>, java.io.Serializable, Cloneable, Comparable<ProductPage> {
  ...
  private static final org.apache.thrift.protocol.TField DISCOUNT_VAL_FIELD_DESC = new org.apache.thrift.protocol.TField("discountVal", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public com.freeb.thrift.DiscountInfo discountVal; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.DISCOUNT_VAL, new org.apache.thrift.meta_data.FieldMetaData("discountVal", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.freeb.thrift.DiscountInfo.class)));
  ...
  public ProductPage(ProductPage other) {
    ...
    if (other.isSetDiscountVal()) {
      this.discountVal = new com.freeb.thrift.DiscountInfo(other.discountVal);
    }
  ...
  public com.freeb.thrift.DiscountInfo getDiscountVal() {
    return this.discountVal;
  }

  public ProductPage setDiscountVal(com.freeb.thrift.DiscountInfo discountVal) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DISCOUNT_VAL:
      if (value == null) {
        ...
        setDiscountVal((com.freeb.thrift.DiscountInfo)value);
      }
      break;
  ...
  public boolean equals(ProductPage that) {
    ...
    if (this_present_discountVal || that_present_discountVal) {
      if (!(this_present_discountVal && that_present_discountVal))
        return false;
      if (!this.discountVal.equals(that.discountVal))
        return false;
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ProductPage struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // DISCOUNT_VAL
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.discountVal = new com.freeb.thrift.DiscountInfo();
              struct.discountVal.read(iprot);
