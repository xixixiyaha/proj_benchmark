...
public class OrderReq implements org.apache.thrift.TBase<OrderReq, OrderReq._Fields>, java.io.Serializable, Cloneable, Comparable<OrderReq> {
  ...
  private static final org.apache.thrift.protocol.TField PROD_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("prodName", org.apache.thrift.protocol.TType.I64, (short)6);
  ...
  private static final int __PRODNAME_ISSET_ID = 4;
  private static final int __ORDERID_ISSET_ID = 5;
  private static final int __PAYMENTID_ISSET_ID = 6;
  ...
  public long getProdName() {
    return this.prodName;
  }

  public OrderReq setProdName(long prodName) {
    this.prodName = prodName;
    setProdNameIsSet(true);
    return this;
  }

  public void unsetProdName() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PRODNAME_ISSET_ID);
  }

  /** Returns true if field prodName is set (has been assigned a value) and false otherwise */
  public boolean isSetProdName() {
    return EncodingUtils.testBit(__isset_bitfield, __PRODNAME_ISSET_ID);
  }

  public void setProdNameIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PRODNAME_ISSET_ID, value);
  }
  ...
  public OrderReq setCartId(com.freeb.thrift.CartInfo cartId) {
    this.cartId = cartId;
    return this;
  }
  ...
  public boolean equals(OrderReq that) {
    ...
    if (this_present_prodName || that_present_prodName) {
      if (!(this_present_prodName && that_present_prodName))
        return false;
      if (this.prodName != that.prodName)
        return false;
    }
  ...
  private static class OrderReqStandardScheme extends StandardScheme<OrderReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrderReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProdName()) {
        ...
        oprot.writeI64(struct.prodName);
        oprot.writeFieldEnd();
      }
