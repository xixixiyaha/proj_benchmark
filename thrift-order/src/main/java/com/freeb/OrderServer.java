...
import com.freeb.thrift.OrderServer.OrderServiceServerImpl;
...
//            InetSocketAddress serverAddress = new InetSocketAddress("10.0.16.14", 8080);
            ...
            serverParams.processor(new OrderService.Processor<OrderService.Iface>(new OrderServiceServerImpl()));
