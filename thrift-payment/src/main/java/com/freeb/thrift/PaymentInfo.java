...
public class PaymentInfo implements org.apache.thrift.TBase<PaymentInfo, PaymentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<PaymentInfo> {
  ...
  private static class PaymentInfoStandardScheme extends StandardScheme<PaymentInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PaymentInfo struct) throws TException {
      ...
      if (!struct.isSetPaymentId()) {
        throw new TProtocolException("Required field 'paymentId' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetPaymentVal()) {
        throw new TProtocolException("Required field 'paymentVal' was not found in serialized data! Struct: " + toString());
      }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaymentInfo struct) throws TException {
      struct.validate();
  ...
  private static class PaymentInfoTupleScheme extends TupleScheme<PaymentInfo> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PaymentInfo struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PaymentInfo struct) throws TException {
